...
- (void)viewDidLoad {
    ...
    citiesButton.frame = CGRectMake(365, 700, 45, 35);
...
- (void) Get {
    NSURL *url = [NSURL URLWithString:@"https://free-api.heweather.com/s6/weather?location=xianshi&key=4598873b53f74eb6b02e51e44f7ea3e1"];
